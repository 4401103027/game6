...
class scene6 extends Phaser.Scene{
	...
	create(){
		...
		this.add.image(160, 410, 'flag').setScale(0.6);
		

		var n1 = this.add.image(220, 432, 'new').setScale(0.85).setInteractive();
		var n2 = this.add.image(473, 305, 'new').setScale(0.85).setInteractive();
		var n3 = this.add.image(500, 490, 'new').setScale(0.85).setInteractive();
