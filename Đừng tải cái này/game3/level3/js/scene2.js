...
var key = "asdfghjkl;_";
var words = ["prey", "pure", "rice", "zero", "crepy"];
var blue_, red_;
...
class scene2 extends Phaser.Scene{
	...
	preload(){
		...
		for (var i in key) {
			this.load.image('char' + key[i], 'assets/lower/char-' + key[i] + '.png');
			this.load.image('blue' + key[i], 'assets/lower/blue-' + key[i] + '.png');
			this.load.image('green' + key[i], 'assets/lower/green-' + key[i] + '.png');
			this.load.image('red' + key[i], 'assets/lower/red-' + key[i] + '.png');

			this.load.image('keyblue' + key[i], 'assets/key2/blue-' + key[i] + '.png');
			this.load.image('keyred' + key[i], 'assets/key2/red-' + key[i] + '.png');
			this.load.image('keygrey' + key[i], 'assets/key2/grey-' + key[i] + '.png');
			console.log(key[i]);
		}
	...
	create(){		
		...
		for (var i in row2) {
			this.add.image(x_key2, y_key2, 'keygrey' + key[i]).setScale(0.8);
