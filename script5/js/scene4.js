// <--chỗ đổ dữ liệu-->
var list3 = [
	'mmm mm, mm. mm/ m,m m,. m,/ m,./.m m.m m., m.. m/m m/, m/. m//',
	',mm ,m, ,m. ,m/ ,,m ,,. ,,/ ,m./.m ,.m ,., ,.. ,/m ,/, ,/. ,//',
	'.mm .m, .m. .m/ .,m .,. .,/ .,./.m ..m .., ... ./m ./, ./. .//',
	'/mm /m, /m. /m/ /,m /,. /,/ /,./.m /.m /., /.. //m //, //. ///',
]
...
class scene4 extends Phaser.Scene{
	...
	create(){
		...
		var str = list3[list3_index];
		var x_char = 50, y_char = 55;
		var char = []
		for (var i = list3_index; i < list3_index + 2; i++) {
